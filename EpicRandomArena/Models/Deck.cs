...
namespace EpicRandomArena.Models
{
    public class Deck
    {
        ...
        public Deck()
        {
            ...
            cards.Add(new Card("Iashchuk", "/EpicRandomArena;component/Graphics/CardFolder/yashchuk.jpg", 7, 5, 13));
            cards.Add(new Card("Loki", "/EpicRandomArena;component/Graphics/CardFolder/loki.jpg", 14, 4, 8));
            cards.Add(new Card("Hapko", "/EpicRandomArena;component/Graphics/CardFolder/hapko.jpg", 7, 2, 13));
            cards.Add(new Card("Half of Truhan", "/EpicRandomArena;component/Graphics/CardFolder/truhan.png", 1, 4, 8));
        }
